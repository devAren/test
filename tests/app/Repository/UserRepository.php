...
//        $this->mailer = $mailer;
     ...
     * @return bool|User
     */
    public function createOrUpdate($id = 0, $request)
    {
        $model = User::firstOrNew($id);
